...
//=========== End scroll-down end back-to-top
...
jQuery(function ($) {
    ...
    $("header .button-open").click(function(){
        $(".navbar-search .form-group").fadeIn();
         $("header .navbar-search").addClass('search-open'); 
        $(this).fadeOut(0);
    });

    $("header .navbar-search .button-open").click(function(){
        $("header .navbar-search input").animate({ 'width': "377px"}, 500); 
                
    });

     $(".navbar-search.search-open .button").click(function(){
        $("header .navbar-search").removeClass('search-open');          
    });
    

    $(document).click(function(e){
        if ($(e.target).parents().filter('header .navbar-search').length != 1) {
            $("header .navbar-search input").animate({ 'width': "22px"}, 10);
...
$(document).ready(function() {
        //=========== Sticky  ===========//
        var block = $(".navbar-main-menu").clone();
        $(".main-menu-fix .container").append(block);

        $(".navbar-switcher").click(function(){
            $(".main-menu-fix").slideToggle(200);
        })     
...
jQuery(function(f){
  var element = f('.navbar-switcher-container');
...
//=========== index.html(btn-pointer)
jQuery(function ($) {
    "use strict";
      $(".services-block .btn-pointer").click(function () {
         $(".form-box-1").slideToggle();
         return false;
       });

    $(".form-box-1 .button-close").click(function () {
         $(".form-box-1").slideToggle();
         return false;
       });
